...
* [Робота із зображеннями](#особливості-розробки)
* [Принцип роботи додатку post_app](#принцип-роботи-додатку-post_app)
* [Принцип роботи реєстрації та авторизації](#принцип-роботи-реєстрації-та-авторизації-користувача)
* [Робота з WebSocket](#робота-з-websocket-запитами)
* [Робота з AJAX](#технологія-ajax)
* [Висновок](#висновок)
---
...
```
##### [⬆ Повернутися до каталогу](#каталог)
...
```
![Принцип роботи авторизації користувача](readme_images/post_video.gif)
##### [⬆ Повернутися до каталогу](#каталог)
---
...
![Принцип роботи авторизації користувача](readme_images/auth_video.gif)
##### [⬆ Повернутися до каталогу](#каталог)
--- 

## Висновок
- Хочу почати з того, що це було нелегко — не лише для мене, а й для всієї команди. Іноді всі наші зусилля не приносили жодного результату, іноді ніхто нічого не робив, і досі я не можу сказати, що ми повністю впоралися з цим завданням. Проте ми намагалися, навчилися багато нового і будемо продовжувати працювати, щоб досягти поставлених цілей.
